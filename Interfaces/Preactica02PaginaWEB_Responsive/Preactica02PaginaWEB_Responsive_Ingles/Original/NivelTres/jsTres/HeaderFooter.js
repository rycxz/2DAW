...
footer.innerHTML=`  <div class="cont2">
            <div class="zonaColaboradores">
                ...
                <div class="TextoColaboradores"><p class="c1">En HusMotors, trabajamos con las marcas líderes del mercado: Suzuki, Kawasaki y Honda,
                     ofreciendo a nuestros clientes una amplia gama de motocicletas de alta calidad. Suzuki nos proporciona modelos versátiles
                     y confiables </p>,<p class="c2"> Kawasaki destaca por sus motos de alto rendimiento, y Honda ofrece opciones seguras y eficientes para todo tipo
                      ...
                      y la innovación que nos caracterizan.</p></div>
            </div>
            <div class="redes">
        ...
        <div class="zonaAviso">
            ...
            <div class="TextoAviso">
                <p class="d1">La página web de HusMotors y todos sus contenidos, incluyendo textos, imágenes, logotipos, gráficos y otros elementos,
                 ...
                 su uso.</p><p class="d2">Queda prohibida su reproducción, distribución o cualquier otro uso sin autorización expresa. HusMotors no se hace responsable
                  del uso indebido de la información en esta web y se reserva el derecho de modificar sus contenidos sin previo aviso. Para consultas
                   sobre este Aviso Legal, puedes contactarnos en support@husmotors.com © HusMotors, 2024. Todos los derechos reservados.</p>
            </div>
        </div>
